...
public class Main {
    ...
    public static void main(String[] args) throws DBException, SQLException {   //Метод только для теста
        ...
        userService.addUser(new User("РусскоеИмя", "404", "maiaxl1", 15L));
        ...
        System.out.println("Пара DartAxis/c2h5oh верна - " + (userService.verifyUserPassword("DartAxis", "c2h5oh") != null ? "да" : "нет"));
        System.out.println("Пара DartAxis/123 верна - " + (userService.verifyUserPassword("DartAxis", "ggg") != null ? "да" : "нет"));
        System.out.println("Пара gUnit/123 верна - " + (userService.verifyUserPassword("gUnit", "123") != null ? "да" : "нет"));
        System.out.println();
